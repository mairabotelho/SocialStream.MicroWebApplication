package com.zipcode.socialStream.security;
...
public class JwtProvider {
    ...
    public void init() throws Exception {
        try {
            ...
            InputStream resourceAsStream = getClass().getResourceAsStream("/socialStream.jks");
    ...
    private PublicKey getPublicKey() throws Exception {
        try {
            return keyStore.getCertificate("socialStream").getPublicKey();
